...
-- ------------------------------------------------------------------------------
-- CATÁLOGO DE SERVICIOS (5 servicios definitivos)
-- ------------------------------------------------------------------------------

-- Primero desactivar cualquier servicio previo que no corresponda
UPDATE `servicios` SET `activo` = 0 WHERE `nombre` NOT IN (
